...
import { fallhojd as fallhojdFor } from './delomraden'
 ...
 * ett beslut, och det avgörs av restid, nattåg och vad liftkortet kostar i
 ...
 *
 * Sedan 21 september 2026 går uträkningen via `lib/delomraden.js`, som
 * fångar de två orter där höjdspannet korsar skilda områden. För de
 * tjugoåtta andra är svaret oförändrat.
 */
export const fallhojd = (r) => fallhojdFor(r)
...
export function alpjamforelse(ort, alla, kurser) {
  ...
  return {
    ...
    // Här låg "vecka" ur est_weekly_cost_eur, som gav sidan raden "Veckan
    // totalt: Alperna 10 600–29 000 kr". Spannet var byggt av trettio tal
    // som aldrig hämtats någonstans ifrån — se migration 024.
