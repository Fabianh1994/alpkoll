 ...
 * permanent vidarebefordran istället för innehåll. `kurerat` är false för
 * par vi inte marknadsför; sidan svarar men står som noindex.
 */
...
export const HUVUDPUNKTER = [
  ...
  },
  {
    ...
    visa: (r, kurser) => pris(r.est_weekly_cost_eur, VALUTA(r), kurser),
    enhet: 'per person',
  },
  {
...
export const GRUPPER = [
  ...
  },
  {
    ...
    falt: [
      ...
      { etikett: 'Vecka totalt', riktning: 'lag', varde: (r) => r.est_weekly_cost_eur, visa: (r, k) => pris(r.est_weekly_cost_eur, VALUTA(r), k) },
    ],
  },
]
